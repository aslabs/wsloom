...
1. Generate an npm **granular access token** with read/write on `@wsloom`
2. Enable **bypass 2FA for automation** (required for provenance publishing)
3. Add to GitHub: **Settings → Secrets and variables → Actions → `NPM_TOKEN`**
